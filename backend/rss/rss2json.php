...
/**
 * @author Berenice Mulubah <cliberiaclearly@gmail.com>
 * @copyright C LIBERIA CLEARLY 2017
 * @package c_liberia_clearly
 * 
 * 
...
$url_feeds["home"] = "http://www.cliberiaclearly.net/feeds/posts/default?alt=rss";
$url_feeds["archive"] = "http://cliberiaclearly.net/feeds/posts/default?limit=30&amp;amp;start-index=31";
...
switch($_GET["json"]){
	case "home": 
		$rest_api = get_rss($url_feeds["home"],$date_format);
		break;
	case "archive": 
		$rest_api = get_rss($url_feeds["archive"],$date_format);
		break;
	case "route":
		$rest_api["routes"][0] = array("namespace"=>"home","methods"=>"GET","link"=>$_SERVER["PHP_SELF"]."?json=home");
		$rest_api["routes"][1] = array("namespace"=>"archive","methods"=>"GET","link"=>$_SERVER["PHP_SELF"]."?json=archive");
		break;
}
