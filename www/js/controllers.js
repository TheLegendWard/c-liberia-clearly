angular.module("c_liberia_clearly.controllers", [])
		...
		confirmPopup.then(function (close){
			if(close){
				localforage.keys().then(function(keys) {
					...
					$state.go("c_liberia_clearly.dashboard");
				}).catch(function(err) {
					$state.go("c_liberia_clearly.dashboard");
				});
			}
...
.controller("about_meCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.last_edit = "table (about_me)" ;
	$scope.$on("$ionicView.afterEnter", function (){
		var page_id = $state.current.name ;
		$rootScope.page_id = page_id.replace(".","-") ;
	});
	...
	// TODO: about_meCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: about_meCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		var appBrowser = window.open($url,"_blank","hardwareback=Done");
		appBrowser.addEventListener("loadstart",function(){
	...
	// TODO: about_meCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		var appWebview = window.open($url,"_blank","location=no");
		appWebview.addEventListener("loadstart",function(){
	...
	// TODO: about_meCtrl --|-- $scope.showAuthentication
	...
	targetQuery = "slug=about-me"; //default param
	raplaceWithQuery = "slug=about-me";
	
	
	// TODO: about_meCtrl --|-- $scope.splitArray
	...
	// TODO: about_meCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://radioapp.radiolib.us/wp-json/wp/v2/pages?slug=about-me";
	// TODO: about_meCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://radioapp.radiolib.us/wp-json/wp/v2/pages?slug=about-me&callback=JSON_CALLBACK";
	// TODO: about_meCtrl --|-- $scope.hashURL
	...
	localforage.getItem("data_about_mes_" + $scope.hashURL, function(err, get_about_mes){
		if(get_about_mes === null){
			data_about_mes =[];
		}else{
			data_about_mes = JSON.parse(get_about_mes);
			$scope.data_about_mes =JSON.parse( get_about_mes);
			$scope.about_mes = [];
			for(lastPush = 0; lastPush < 50; lastPush++) {
				if (angular.isObject(data_about_mes[lastPush])){
					$scope.about_mes.push(data_about_mes[lastPush]);
				};
			}
			$timeout(function() {
				$ionicLoading.hide();
	...
	if(data_about_mes === null ){
		data_about_mes =[];
	}
	if(data_about_mes.length === 0 ){
		$timeout(function() {
			...
			$http.get(url_request,http_header).then(function(response) {
				data_about_mes = response.data;
				console.log("%cSuccessfully","color:blue;font-size:18px");
				console.dir(data_about_mes);
				$scope.data_about_mes = response.data;
				// TODO: about_meCtrl --|---------- set:localforage
				localforage.setItem("data_about_mes_" + $scope.hashURL, JSON.stringify(data_about_mes));
				$scope.about_mes = [];
				for(lastPush = 0; lastPush < 50; lastPush++) {
					if (angular.isObject(data_about_mes[lastPush])){
						$scope.about_mes.push(data_about_mes[lastPush]);
				...
				$timeout(function() {
					...
					if(response.status ===401){
						// TODO: about_meCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: about_meCtrl --|------------ error:Message
	...
	// TODO: about_meCtrl --|-- $scope.doRefresh
...
// TODO: contact_informationCtrl --|-- 
.controller("contact_informationCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: contact_informationCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: contact_informationCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: contact_informationCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		var appBrowser = window.open($url,"_blank","hardwareback=Done");
		appBrowser.addEventListener("loadstart",function(){
	...
	// TODO: contact_informationCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		var appWebview = window.open($url,"_blank","location=no");
		appWebview.addEventListener("loadstart",function(){
	...
	// TODO: contact_informationCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: contact_informationCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: contact_informationCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `contact_information` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("homeCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	$rootScope.last_edit = "table (home)" ;
	$scope.$on("$ionicView.afterEnter", function (){
		var page_id = $state.current.name ;
		$rootScope.page_id = page_id.replace(".","-") ;
	});
	...
	// TODO: homeCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var authPopup = $ionicPopup.show({
			template: ' This page required login',
			title: "Authorization",
	...
	var raplaceWithQuery = "";
	//fix url Top News
	targetQuery = "json=home"; //default param
	raplaceWithQuery = "json=home";
	
	
	// TODO: homeCtrl --|-- $scope.splitArray
	$scope.splitArray = function(items,cols,maxItem) {
		var newItems = [];
		if(maxItem == 0){
			maxItem = items.length;
	...
	// TODO: homeCtrl --|-- $scope.addToVirtual
	$scope.addToDbVirtual = function(newItem){
		var is_already_exist = false ;
		// animation loading 
		$ionicLoading.show();
		var virtual_items = []; 
		localforage.getItem("home_bookmark", function(err,dbVirtual){
			if(dbVirtual === null){
				virtual_items = [];
			}else{
				try{
			...
			localforage.setItem("home_bookmark",JSON.stringify(virtual_items));
			$timeout(function(){
				$ionicLoading.hide();
			},200);
		}).catch(function(err){
	...
	// TODO: homeCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://ireplib.com/rss2json.php?json=home";
	// TODO: homeCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://ireplib.com/rss2json.php?json=home&callback=JSON_CALLBACK";
	// TODO: homeCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash( $scope.fetchURL.replace(targetQuery,raplaceWithQuery));
	...
	localforage.getItem("data_homes_" + $scope.hashURL, function(err, get_homes){
		if(get_homes === null){
			data_homes =[];
		}else{
			data_homes = JSON.parse(get_homes);
			$scope.data_homes =JSON.parse( get_homes);
			$scope.homes = [];
			for(lastPush = 0; lastPush < 50; lastPush++) {
				if (angular.isObject(data_homes[lastPush])){
					$scope.homes.push(data_homes[lastPush]);
				};
			}
			$timeout(function() {
				$ionicLoading.hide();
	...
	if(data_homes.length === 0 ){
		$timeout(function() {
			...
			// TODO: homeCtrl --|-- $http.get
			console.log("%cRetrieving JSON: %c" + url_request,"color:blue;font-size:18px","color:red;font-size:18px");
			$http.get(url_request,http_header).then(function(response) {
				data_homes = response.data;
				console.log("%cSuccessfully","color:blue;font-size:18px");
				console.dir(data_homes);
				$scope.data_homes = response.data;
				// TODO: homeCtrl --|---------- set:localforage
				localforage.setItem("data_homes_" + $scope.hashURL, JSON.stringify(data_homes));
				$scope.homes = [];
				for(lastPush = 0; lastPush < 50; lastPush++) {
					if (angular.isObject(data_homes[lastPush])){
						$scope.homes.push(data_homes[lastPush]);
				...
				$timeout(function() {
					...
					console.log("%cRetrieving again: %c" + url_request,"color:blue;font-size:18px","color:red;font-size:18px");
					// TODO: homeCtrl --|------ $http.jsonp
					$http.jsonp(url_request,http_header).success(function(data){
						data_homes = data;
						$scope.data_homes = data;
						$ionicLoading.hide();
						// TODO: homeCtrl --|---------- set:localforage
						localforage.setItem("data_homes_" + $scope.hashURL,JSON.stringify(data_homes));
						controller_by_user();
					...
					if(response.status ===401){
						// TODO: homeCtrl --|------------ error:Unauthorized
						$scope.showAuthentication();
					}else{
						// TODO: homeCtrl --|------------ error:Message
						var data = { statusText:response.statusText, status:response.status };
						var alertPopup = $ionicPopup.alert({
							title: "Network Error" + " (" + data.status + ")",
							template: "An error occurred while collecting data.",
...
// TODO: home_2_singlesCtrl --|-- 
.controller("home_2_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: home_2_singlesCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: home_2_singlesCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: home_2_singlesCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		var appBrowser = window.open($url,"_blank","hardwareback=Done");
		appBrowser.addEventListener("loadstart",function(){
	...
	// TODO: home_2_singlesCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		var appWebview = window.open($url,"_blank","location=no");
		appWebview.addEventListener("loadstart",function(){
	...
	// TODO: home_2_singlesCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: home_2_singlesCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: home_2_singlesCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `home_2__singles` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: home_bookmarkCtrl --|-- 
.controller("home_bookmarkCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: home_bookmarkCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: home_bookmarkCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: home_bookmarkCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		var appBrowser = window.open($url,"_blank","hardwareback=Done");
		appBrowser.addEventListener("loadstart",function(){
	...
	// TODO: home_bookmarkCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		var appWebview = window.open($url,"_blank","location=no");
		appWebview.addEventListener("loadstart",function(){
	...
	// TODO: home_bookmarkCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: home_bookmarkCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: home_bookmarkCtrl --|-- Database for Cart/Bookmark
	// TODO: home_bookmarkCtrl --|-- $scope.loadDbVirtualHome
	 
	$scope.loadDbVirtualHome = function(){
		$ionicLoading.show();
		//home_bookmark
		$scope.home_bookmark = []; 
		localforage.getItem("home_bookmark", function(err,dbVirtual){
			if(dbVirtual === null){
				...
				try{
					$scope.home_bookmark = JSON.parse(dbVirtual); 
				}catch (e){
					$scope.home_bookmark = []; 
				}
			}
	...
	$scope.$on("$ionicView.enter", function (){
		$scope.loadDbVirtualHome();
	});
	// TODO: home_bookmarkCtrl --|-- $scope.clearDbVirtualHome
	$scope.clearDbVirtualHome = function(){
		localforage.setItem("home_bookmark",[]);
		$timeout(function(){
			$scope.loadDbVirtualHome();
		},200);
	};
	// TODO: home_bookmarkCtrl --|-- $scope.removeDbVirtualHome
	$scope.removeDbVirtualHome = function(itemId){
		var virtual_items = [];
		var last_items = $scope.home_bookmark;
		for(var z=0;z<last_items.length;z++){
	...
	// TODO: home_bookmarkCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("%cerror: %cPage: `home_bookmark` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
// TODO: home_singlesCtrl --|-- 
.controller("home_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	// TODO: home_singlesCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: home_singlesCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: home_singlesCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		var appBrowser = window.open($url,"_blank","hardwareback=Done");
		appBrowser.addEventListener("loadstart",function(){
	...
	// TODO: home_singlesCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		var appWebview = window.open($url,"_blank","location=no");
		appWebview.addEventListener("loadstart",function(){
	...
	// TODO: home_singlesCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: home_singlesCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: home_singlesCtrl --|-- $scope.showAuthentication
	$scope.showAuthentication  = function(){
		var authPopup = $ionicPopup.show({
			template: ' This page required login',
			title: "Authorization",
	...
	// TODO: home_singlesCtrl --|-- $scope.addToVirtual(); //data single
	$scope.addToDbVirtual = function(newItem){
		var is_already_exist = false ;
		// animation loading 
		$ionicLoading.show();
	...
	// TODO: home_singlesCtrl --|-- $scope.fetchURL
	$scope.fetchURL = "http://ireplib.com/rss2json.php?json=home";
	// TODO: home_singlesCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "http://ireplib.com/rss2json.php?json=home&callback=JSON_CALLBACK";
	// TODO: home_singlesCtrl --|-- $scope.hashURL
	$scope.hashURL = md5.createHash($scope.fetchURL);
	
	var current_item = [];
	localforage.getItem("data_homes_" + $scope.hashURL, function(err, get_datas){
		if(get_datas === null){
			current_item = [];
		}else{
			if(get_datas !== null){
	...
	if( current_item.length === 0 ){
		...
		// TODO: home_singlesCtrl --|-- $http.get
		$http.get($scope.fetchURL,http_header).then(function(response) {
			// Get data single
			var datas = response.data;
			// TODO: home_singlesCtrl --|---------- set:localforage
			localforage.setItem("data_homes_"+ $scope.hashURL,JSON.stringify(datas));
			for (var i = 0; i < datas.length; i++) {
				if((datas[i].id ===  parseInt(itemID)) || (datas[i].id === itemID.toString())) {
					current_item = datas[i] ;
				}
		...
		// TODO: home_singlesCtrl --|-- $scope.doRefresh
	$scope.doRefresh = function(){
		// Retrieving data
		var itemID = $stateParams.id;
		var current_item = [];
		...
		$http.get($scope.fetchURL,http_header).then(function(response) {
			...
			// Error message
		// TODO: home_singlesCtrl --|---------- $http.jsonp
	...
	// TODO: home_singlesCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `home_singles` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
...
.controller("videosCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$scope.fetchURL = "https://www.googleapis.com/youtube/v3/playlistItems?maxResults=50&part=id,snippet&playlistId=PLndMjMTpf5wAr5WuezVndHThYSe8Yovfs&key=AIzaSyA6JsObPXuSp4RKQouzZZgMrUzEHp9KrU8";
	// TODO: videosCtrl --|-- $scope.fetchURLp
	$scope.fetchURLp = "https://www.googleapis.com/youtube/v3/playlistItems?maxResults=50&part=id,snippet&playlistId=PLndMjMTpf5wAr5WuezVndHThYSe8Yovfs&key=AIzaSyA6JsObPXuSp4RKQouzZZgMrUzEHp9KrU8&callback=JSON_CALLBACK";
...
// TODO: youtube_playlist_singlesCtrl --|-- 
.controller("youtube_playlist_singlesCtrl", function($ionicConfig,$scope,$rootScope,$state,$location,$ionicScrollDelegate,$ionicListDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$interval,$ionicLoading,$ionicPopup,$ionicPopover,$ionicActionSheet,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64,md5,$document,$sce,$ionicGesture,$translate,tmhDynamicLocale){
	...
	$rootScope.grid128 = parseInt($rootScope.ionWidth / 128) ;
	$rootScope.grid256 = parseInt($rootScope.ionWidth / 256) ;
	$rootScope.last_edit = "table (youtube_playlist)" ;
	$scope.$on("$ionicView.afterEnter", function (){
		var page_id = $state.current.name ;
		$rootScope.page_id = page_id.replace(".","-") ;
	});
	...
	// TODO: youtube_playlist_singlesCtrl --|-- $scope.scrollTop
	$rootScope.scrollTop = function(){
		$timeout(function(){
			$ionicScrollDelegate.$getByHandle("top").scrollTop();
		},100);
	};
	// TODO: youtube_playlist_singlesCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: youtube_playlist_singlesCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		var appBrowser = window.open($url,"_blank","hardwareback=Done");
		appBrowser.addEventListener("loadstart",function(){
	...
	// TODO: youtube_playlist_singlesCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		var appWebview = window.open($url,"_blank","location=no");
		appWebview.addEventListener("loadstart",function(){
	...
	// TODO: youtube_playlist_singlesCtrl --|-- $scope.toggleGroup
	$scope.toggleGroup = function(group) {
		if ($scope.isGroupShown(group)) {
			$scope.shownGroup = null;
		} else {
	...
	// TODO: youtube_playlist_singlesCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: youtube_playlist_singlesCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
...
$ionicConfig.backButton.text("");			
			...
			console.log("%cerror: %cPage: `youtube_playlist_singles` and field: `Custom Controller`","color:blue;font-size:18px","color:red;font-size:18px");
			console.dir(e);
		}
	}
	$scope.rating = {};
